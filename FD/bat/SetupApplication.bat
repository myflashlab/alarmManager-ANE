...
:: Android packaging
set AND_CERT_NAME="exAlarm"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\exAlarm.p12
...
set IOS_PROVISION_DEV=cert\exAlarm.mobileprovision
...
set APP_ID=com.doitflash.exAlarm

:: Output packages
set DIST_PATH=dist
set DIST_NAME=exAlarm
